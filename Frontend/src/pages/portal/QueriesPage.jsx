...
import { 
  HelpCircle, CheckCircle, Search, RefreshCw, AlertTriangle, MessageSquare, ClipboardCheck, ArrowRight
} from 'lucide-react';
    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="bg-slate-950 p-5 rounded-2xl border border-slate-800 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="relative min-w-[200px] w-full sm:w-auto">
          ...
          <input
            type="text"
            placeholder="Search tickets by customer / order..."
            value={searchQuery}
      ...
      <div className="space-y-4">
        {filteredQueries.map(q => (
          <div key={q.id} className="bg-slate-950 p-6 rounded-2xl border border-slate-800 space-y-4">
            ...
            {/* Actions Footer */}
            {q.status !== 'RESOLVED' && (
              <div className="border-t border-slate-900 pt-4 flex flex-wrap items-center justify-end gap-2">
                {q.status === 'OPEN' && (
                  <button
                ...
                <button
                  ...
                  className="px-4 py-1.5 bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-bold rounded-lg transition-colors flex items-center space-x-1.5"
                >
        ...
        {filteredQueries.length === 0 && (
          <div className="p-12 text-center bg-slate-950 rounded-2xl border border-slate-800 text-slate-500 font-semibold">
